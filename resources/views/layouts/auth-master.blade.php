                ...
                <li class="upper-links dropdown show-on-hover"><a class="links dropdown-toggle" 
                  ...
                  <ul class="dropdown-menu" role="menu" id="ul">
                    ...
                    @if(Auth::check())
                                    ...
                                    @else
                                        <li ><a href="{{route('admin.dashboard')}}" style="color: #000"> <i class="glyphicon glyphicon-user"></i> Login</a></li>
                                    @endif 
                        </ul> 
                </li>
              </ul>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="../frontendassets/images/hallmyanmar.png" alt="logo" width="300" class="shadow-light">
            </div>
            @if(session()->has('info'))
